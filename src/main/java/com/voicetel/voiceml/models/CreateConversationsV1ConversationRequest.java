...
/** Form body for {@code POST /v1/Conversations}. All fields optional. */
public final class CreateConversationsV1ConversationRequest {
    ...
    private final String bindingsEmailAddress;
    private final String bindingsEmailName;

    private CreateConversationsV1ConversationRequest(Builder b) {
        ...
        this.bindingsEmailAddress = b.bindingsEmailAddress;
        this.bindingsEmailName = b.bindingsEmailName;
    }
    ...
    public Map<String, Object> toForm() {
        ...
        if (bindingsEmailAddress != null) f.put("Bindings.Email.Address", bindingsEmailAddress);
        if (bindingsEmailName != null) f.put("Bindings.Email.Name", bindingsEmailName);
        return f;
    }
    ...
    public static final class Builder {
        ...
        public Builder bindingsEmailAddress(String s) { this.bindingsEmailAddress = s; return this; }
        public Builder bindingsEmailName(String s) { this.bindingsEmailName = s; return this; }

        public CreateConversationsV1ConversationRequest build() {
            return new CreateConversationsV1ConversationRequest(this);
        }
    }
}
