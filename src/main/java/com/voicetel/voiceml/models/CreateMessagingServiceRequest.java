...
/**
 * Form body for {@code POST /v1/Services} on the messaging host. {@code FriendlyName} is the only
 * required field; every other field is an optional configuration toggle.
 */
public final class CreateMessagingServiceRequest {
    ...
    private CreateMessagingServiceRequest(Builder b) {
    ...
    public static final class Builder {
        ...
        public CreateMessagingServiceRequest build() {
            return new CreateMessagingServiceRequest(this);
        }
    }
}
