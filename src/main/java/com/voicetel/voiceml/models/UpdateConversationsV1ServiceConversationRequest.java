...
/** Form body for {@code POST /v1/Services/{ChatServiceSid}/Conversations/{ConversationSid}}. */
public final class UpdateConversationsV1ServiceConversationRequest {
    ...
    private UpdateConversationsV1ServiceConversationRequest(Builder b) {
    ...
    public static final class Builder {
        ...
        public UpdateConversationsV1ServiceConversationRequest build() {
            return new UpdateConversationsV1ServiceConversationRequest(this);
        }
    }
}
