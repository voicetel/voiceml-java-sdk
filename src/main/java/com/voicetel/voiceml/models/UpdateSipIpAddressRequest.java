...
/** Form body for {@code POST .../IpAddresses/{Sid}}. */
public final class UpdateSipIpAddressRequest {

    private final String friendlyName;
    private final String ipAddress;
    private final Integer cidrPrefixLength;

    private UpdateSipIpAddressRequest(Builder b) {
    ...
    public static final class Builder {
        ...
        public UpdateSipIpAddressRequest build() { return new UpdateSipIpAddressRequest(this); }
    }
}
