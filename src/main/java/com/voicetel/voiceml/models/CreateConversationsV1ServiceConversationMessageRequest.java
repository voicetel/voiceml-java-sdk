...
/** Form body for {@code POST /v1/Services/{ChatServiceSid}/Conversations/{ConversationSid}/Messages}. */
public final class CreateConversationsV1ServiceConversationMessageRequest {
    ...
    private CreateConversationsV1ServiceConversationMessageRequest(Builder b) {
    ...
    public static final class Builder {
        ...
        public CreateConversationsV1ServiceConversationMessageRequest build() {
            return new CreateConversationsV1ServiceConversationMessageRequest(this);
        }
    }
}
