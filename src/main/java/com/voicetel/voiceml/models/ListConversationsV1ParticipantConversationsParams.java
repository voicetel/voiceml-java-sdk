...
/** Query params for {@code GET /v1/ParticipantConversations}. */
public final class ListConversationsV1ParticipantConversationsParams {

    private final String identity;
    private final String address;
    private final Integer pageSize;

    private ListConversationsV1ParticipantConversationsParams(Builder b) {
    ...
    public static final class Builder {
        ...
        public ListConversationsV1ParticipantConversationsParams build() {
            return new ListConversationsV1ParticipantConversationsParams(this);
        }
    }
}
