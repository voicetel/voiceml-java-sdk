...
/** JSON body for {@code PUT /v1/Assistants/{id}}. All fields optional. */
public final class UpdateAssistantsV1AssistantRequest {
    ...
    private UpdateAssistantsV1AssistantRequest(Builder b) {
        this.name = b.name;
        this.owner = b.owner;
    ...
    public static final class Builder {
        ...
        public UpdateAssistantsV1AssistantRequest build() {
            return new UpdateAssistantsV1AssistantRequest(this);
        }
    }
}
