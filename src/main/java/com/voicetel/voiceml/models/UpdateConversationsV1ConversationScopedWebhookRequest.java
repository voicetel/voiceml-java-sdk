...
/** Form body for {@code POST /v1/Conversations/{ConversationSid}/Webhooks/{WebhookSid}}. */
public final class UpdateConversationsV1ConversationScopedWebhookRequest {

    private final String configurationUrl;
    private final String configurationMethod;
    private final String configurationFlowSid;

    private UpdateConversationsV1ConversationScopedWebhookRequest(Builder b) {
    ...
    public static final class Builder {
        ...
        public UpdateConversationsV1ConversationScopedWebhookRequest build() {
            return new UpdateConversationsV1ConversationScopedWebhookRequest(this);
        }
    }
}
