...
/** Form body for {@code POST /v1/Users}. {@code Identity} required. */
public final class CreateConversationsV1UserRequest {
    ...
    private CreateConversationsV1UserRequest(Builder b) {
    ...
    public static final class Builder {
        ...
        public CreateConversationsV1UserRequest build() {
            return new CreateConversationsV1UserRequest(this);
        }
    }
}
