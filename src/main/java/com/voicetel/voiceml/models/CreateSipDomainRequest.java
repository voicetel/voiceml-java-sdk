...
/** Form body for {@code POST /SIP/Domains}. {@code domainName} is required. */
public final class CreateSipDomainRequest {
    ...
    private CreateSipDomainRequest(Builder b) {
    ...
    public Map<String, Object> toForm() {
        ...
        if (domainName != null) f.put("DomainName", domainName);
    ...
    public static final class Builder {
        ...
        public Builder domainName(String s) { this.domainName = s; return this; }
        ...
        public CreateSipDomainRequest build() { return new CreateSipDomainRequest(this); }
    }
}
