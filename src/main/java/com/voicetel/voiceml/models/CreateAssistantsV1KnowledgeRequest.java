...
/** JSON body for {@code POST /v1/Knowledge}. {@code name} and {@code type} are required. */
public final class CreateAssistantsV1KnowledgeRequest {
    ...
    private CreateAssistantsV1KnowledgeRequest(Builder b) {
        this.name = b.name;
        this.type = b.type;
    ...
    public static final class Builder {
        ...
        public CreateAssistantsV1KnowledgeRequest build() {
            return new CreateAssistantsV1KnowledgeRequest(this);
        }
    }
}
