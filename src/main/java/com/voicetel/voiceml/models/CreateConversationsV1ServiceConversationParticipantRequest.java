...
/** Form body for {@code POST /v1/Services/{ChatServiceSid}/Conversations/{ConversationSid}/Participants}. */
public final class CreateConversationsV1ServiceConversationParticipantRequest {
    ...
    private CreateConversationsV1ServiceConversationParticipantRequest(Builder b) {
    ...
    public static final class Builder {
        ...
        public CreateConversationsV1ServiceConversationParticipantRequest build() {
            return new CreateConversationsV1ServiceConversationParticipantRequest(this);
        }
    }
}
