...
/** Form body for {@code POST /v1/Credentials}. {@code Type} required. */
public final class CreateConversationsV1CredentialRequest {
    ...
    private CreateConversationsV1CredentialRequest(Builder b) {
        this.type = b.type;
    ...
    public static final class Builder {
        ...
        public CreateConversationsV1CredentialRequest build() {
            return new CreateConversationsV1CredentialRequest(this);
        }
    }
}
