...
/** Form body for {@code POST /v1/Services/{ChatServiceSid}/Users/{Sid}}. */
public final class UpdateConversationsV1ServiceUserRequest {

    private final String friendlyName;
    private final String attributes;
    private final String roleSid;

    private UpdateConversationsV1ServiceUserRequest(Builder b) {
    ...
    public static final class Builder {
        ...
        public UpdateConversationsV1ServiceUserRequest build() {
            return new UpdateConversationsV1ServiceUserRequest(this);
        }
    }
}
