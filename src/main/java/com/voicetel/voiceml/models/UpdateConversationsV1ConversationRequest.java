...
/** Form body for {@code POST /v1/Conversations/{ConversationSid}}. */
public final class UpdateConversationsV1ConversationRequest {
    ...
    private UpdateConversationsV1ConversationRequest(Builder b) {
    ...
    public static final class Builder {
        ...
        public UpdateConversationsV1ConversationRequest build() {
            return new UpdateConversationsV1ConversationRequest(this);
        }
    }
}
