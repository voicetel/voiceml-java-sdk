...
/** Query parameters for {@code GET /v1/Tools}. */
public final class ListAssistantsV1ToolsParams {

    private final String assistantId;
    private final Integer pageSize;

    private ListAssistantsV1ToolsParams(Builder b) {
    ...
    public static final class Builder {
        ...
        public ListAssistantsV1ToolsParams build() {
            return new ListAssistantsV1ToolsParams(this);
        }
    }
}
